...
public class PlayerAttack : MonoBehaviour
{
    ...
    private bool swardAttackKey = false;
    ...
    public void SetAttackKey(bool is_attck)
    {
        if (isAttack == false)//Player is not attacking and ready to new attack
            attackKey = is_attck;
        else
            attackKey = is_attck;
    }
    public void SetSwardAttack(bool is_sward_attack)
    {
                if (isAttack == false)//Player is not attacking and ready to new attack
            swardAttackKey = is_sward_attack;
        else
            swardAttackKey = is_sward_attack;
    }
